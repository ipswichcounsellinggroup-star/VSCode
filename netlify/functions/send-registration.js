exports.handler = async function (event) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return { statusCode: 500, body: `Email send failed: ${response.status} ${responseText}` };
        }
        ...
        console.error('Unhandled error in send-registration:', err.message, err.stack);
